...
{   
    ...
    public void Should_find_shortest_path_from_a_valid_graph()
    {
        ...
        network.AddHub("GRU", "BRC", 10);
        network.AddHub("BRC", "SCL", 5);
        network.AddHub("GRU", "CDG", 75);
        network.AddHub("GRU", "SCL", 20);
        network.AddHub("GRU", "ORL", 56);
        network.AddHub("ORL", "CDG", 5);
        network.AddHub("SCL", "ORL", 20);
    ...
    {
        var network = new FlightNetwork();
        network.AddHub("LAX", "BRC", 10);
        network.AddHub("BRC", "SCL", 5);
        network.AddHub("LAX", "CDG", 75);
        network.AddHub("LAX", "SCL", 20);
        network.AddHub("LAX", "ORL", 56);
        network.AddHub("ORL", "CDG", 5);
        network.AddHub("SCL", "ORL", 20);
